      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 bg-zinc-950 border-l-0 lg:border-l border-zinc-900 min-h-screen">
        ...
        >
          ...
          <motion.div {...fade} transition={{ delay: 0.1 }}>
            ...
            <p className="text-sm text-zinc-500 mt-1">Sign in to your research terminal</p>
          </motion.div>
          ...
          <motion.form {...fade} transition={{ delay: 0.2 }} onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-[10px] font-mono text-zinc-500 hover:text-teal-400 transition-colors"
                >
                  Forgot password?
                </button>
              </div>

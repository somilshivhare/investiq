    ...
    <div className="relative flex min-h-screen w-screen items-center justify-center bg-dark-bg p-4 overflow-hidden">
      ...
      <div className="glass-panel w-full max-w-md p-8 border border-dark-border/60 bg-dark-card/45 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">Welcome to <span className="bg-gradient-to-r from-brand-emerald to-brand-teal bg-clip-text text-transparent">InvestIQ</span></h1>
          <p className="text-sm text-slate-400 mt-1">AI-Powered Investment Intelligence</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-slate-400">
          New to InvestIQ?{' '}
          <Link to="/signup" className="text-brand-emerald hover:underline hover:text-brand-teal transition-colors font-medium">
            Create an Account
          </Link>
        </div>
      </div>
